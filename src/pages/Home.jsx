    ...
    return (
        <>
            <div className='bg-black text-white flex justify-center items-center py-25 px-10 '>
                <div className='flex sm:flex-row flex-col justify-between items-center max-w-[1100px] sm:gap-3 gap-10 w-full'>
                    <div className='sm:w-[52%] '>
                        <h1 className='sm:text-5xl text-4xl font-bold '>Explore the world, One Country at a time.</h1>
                    ...
                    <div>
                        <img src="world.png" alt="WorldImage" className='h-[300px] w=[300px]' />
                    </div>
                </div>
            </div>
            <About/>
